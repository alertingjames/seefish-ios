...
class FollowersViewController: BaseViewController, UICollectionViewDelegate, UICollectionViewDataSource {
...
//        self.userList.reloadData()
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.getFollowers(me_id: thisUser.idx, member_id: gUser.idx)
    }
