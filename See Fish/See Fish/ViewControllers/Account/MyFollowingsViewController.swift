...
class MyFollowingsViewController: BaseViewController, UICollectionViewDelegate, UICollectionViewDataSource {
...
//        self.userList.reloadData()
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.getFollowings(me_id: thisUser.idx, member_id: thisUser.idx)
    }
