...
class MyFollowersViewController: BaseViewController, UICollectionViewDelegate, UICollectionViewDataSource {
...
//        self.userList.reloadData()
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.getFollowers(me_id: thisUser.idx, member_id: thisUser.idx)
    }
    ...
    func getFollowers(me_id:Int64, member_id:Int64){
        self.showLoadingView()
        APIs.getFollowers(me_id:me_id, member_id: member_id, handleCallback: {
