...
extension MeasureViewController: ARSCNViewDelegate{
    ...
    func renderer(_ renderer: SCNSceneRenderer, updateAtTime time: TimeInterval) {
        ...
        DispatchQueue.main.async {
            ...
            self.settingsConstraint.constant = 26        //////////////////////////////////////////////////
...
class MeasureViewController: UIViewController {
    ...
    @IBAction func captureScreen(_ sender: Any) {
        ...
        if gFishViewController != nil {
            gFishViewController.image = renderedImage
            gFishViewController.img_fish.image = renderedImage
            gFishViewController.img_fish.contentMode = .scaleAspectFit
            gFishViewController.img_fish.frame.size.width = gFishViewController.screenWidth
            gFishViewController.img_fish.frame.size.height = gFishViewController.screenHeight - 190
            gFishViewController.imageFile = renderedImage.jpegData(compressionQuality: 0.8)
            gFishViewController.ic_fish.isHidden = true
